...
export function NewHabitForm() {
  ...
  return (
    <form className="w-full flex flex-col mt-6" onSubmit={createNewHabit}>
      ...
      <button
        type="submit"
        className="mt-6 rounded-lg p-4 flex gap-1 items-center font-semibold bg-green-600 justify-center hover:bg-green-500 transition-colors focus:outline-none focus:ring-2 focus:ring-green-600 focus:ring-offset-2 focus:ring-offset-zinc-900"
      >
